            ...
            <body>  
                <div class="brand row">
                    <div class="col-xs-4 brand-social ">
                        ...
                        onmouseout="logo_mouseout('icon-ve')" id="icon-ve" src="img/icon/icon-ve-type2.png"/></a>
                        <a href="https://www.pinterest.com/" target="_blank"><img class="social_icon" onmouseover="logo_mousein('icon-pt')" 
                        onmouseout="logo_mouseout('icon-pt')" id="icon-pt" src="img/icon/icon-pt-type2.png"/></a>
                        <a href="https://www.instragram.com/" target="_blank"><img class="social_icon" onmouseover="logo_mousein('icon-ig')" 
                        onmouseout="logo_mouseout('icon-ig')" id="icon-ig" src="img/icon/icon-ig-type2.png"/></a>
                        <a href="https://www.facebook.com/" target="_blank"><img class="social_icon" onmouseover="logo_mousein('icon-fb')" 
                        onmouseout="logo_mouseout('icon-fb')" id="icon-fb" src="img/icon/icon-fb-type2.png"/></a>
                    </div>
                    ...
                    <div class="pero-font time-text col-xs-4 brand-time "  align="center">
                        <?php 
                        echo '<span class="uppercase time_text">'.date('D j M').'</span><br>';

                        foreach ($lang as $a) {

                         echo '<a href="index.php?lang='.$a['lang_code'].'"><button class="bg-gray pero-font btn btn-default lowercase" > '.$a['lang_code'].' </button></a>';
